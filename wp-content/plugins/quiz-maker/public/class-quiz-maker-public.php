        ...
        foreach($ids as $key => $id){
            ...
            if (!empty($question)) {
                ...
                if ($question['question_image'] != NULL) {
                    ...
                    $question_image = '<div class="ays-image-question-img"><img src="' . $question['question_image'] . '" '. $question_image_lazy_loading_attr .' alt="'. $question_image_alt_text .'" ' . $question_image_style . '></div>';
                }
                $answer_view_class = "";
                $question_hint = '';
                $user_explanation = "";
